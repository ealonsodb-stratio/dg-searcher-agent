...
object BootDGIndexer extends App {
  ...
  val dgExtractorParams: DGExtractorParams = new DGExtractorParams(sourceDao, AppConf.extractorLimit, AppConf.extractorPeriodMs, AppConf.extractorSchedulerMode, AppConf.extractorExponentialbackoffPauseMs, AppConf.extractorExponentialbackoffMaxErrorRetry, AppConf.extractorDelayMs)
